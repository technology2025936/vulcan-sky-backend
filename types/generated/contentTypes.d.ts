...
export interface ApiAviationEnquiryAviationEnquiry
  extends Struct.CollectionTypeSchema {
  collectionName: 'aviation_enquiries';
  info: {
    displayName: 'Aviation Enquiry';
    pluralName: 'aviation-enquiries';
    singularName: 'aviation-enquiry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    careerGoal: Schema.Attribute.Blocks;
    ...
    licence: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::aviation-enquiry.aviation-enquiry'
    > &
      Schema.Attribute.Private;
    medical: Schema.Attribute.Text;
